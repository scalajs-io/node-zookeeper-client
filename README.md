...
================================
This is a Scala.js type-safe binding for [node-zookeeper-client](https://www.npmjs.com/package/node-zookeeper-client)
...
```sbt
libraryDependencies += "io.scalajs.npm" %%% "node-zookeeper-client" % "0.2.2"
```
